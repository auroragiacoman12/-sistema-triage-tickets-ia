...
| Recurso | Enlace |
|---|---|
| Dashboard de control (KPIs y tasa de errores) | [Ver en Airtable Interfaces](https://airtable.com/appSuLAfznvdFKpCI/shr7lmiFop6sArm9H) |
...
| [`evidencia_flujo.pdf`](./evidencia_flujo.pdf) | Capturas de pantalla del flujo funcionando de punta a punta (camino feliz) |
